...
static const satlink_modcod_t k_modcods[SATLINK_MODCOD_COUNT] = {
    ...
    {1U, SATLINK_MOD_QPSK, SATLINK_CONV_RATE_1_2, "QPSK-1/2", 4.5F, 1.0F},
    {2U, SATLINK_MOD_QPSK, SATLINK_CONV_RATE_3_4, "QPSK-3/4", 7.0F, 1.5F},
    {3U, SATLINK_MOD_8PSK, SATLINK_CONV_RATE_2_3, "8PSK-2/3", 10.0F, 2.0F},
    {4U, SATLINK_MOD_8PSK, SATLINK_CONV_RATE_5_6, "8PSK-5/6", 12.5F, 2.5F},
};
