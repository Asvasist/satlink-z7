...
DESCRIPTION = "A/B boot confirmation and update script, CAN bus bring-up, housekeeping controller firmware loader."
LICENSE = "MIT"
...
do_install() {
    ...
    install -m 0644 ${S}/satlink-boot-ok.service ${S}/satlink-can0.service \
        ${S}/satlink-hkc-loader.service ${D}${systemd_system_unitdir}/
...
RDEPENDS:${PN} = "satlink-tools libubootenv-bin iproute2"
